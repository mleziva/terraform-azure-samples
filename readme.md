...
Before running terraform plan, rename set-environmentvars.ps1.example to set-environmentvars.ps1 and set the environment variables to the correct values
